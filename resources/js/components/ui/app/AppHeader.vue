...
import AppLogo from '@/components/ui/app/AppLogo.vue';
...
import UserMenuContent from '@/components/ui/user/UserMenuContent.vue';
    ...
    <div>
        <div class="border-b border-sidebar-border/80">
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <Link :href="conversationIndex().url" class="flex items-center gap-x-2">
                    <AppLogo />
                </Link>
